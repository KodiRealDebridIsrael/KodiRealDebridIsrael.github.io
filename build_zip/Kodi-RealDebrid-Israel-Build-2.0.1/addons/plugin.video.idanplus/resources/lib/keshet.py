...
def GetCategoriesList(iconimage):
	...
	common.addDir(name, "{0}/mako-vod-more/concerts".format(baseUrl), 1, common.GetIconFullPath('live-music.jpg'), infos={"Title": name, "Plot": "צפיה בהופעות חיות"}, module=module)
