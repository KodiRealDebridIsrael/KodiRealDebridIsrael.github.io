...
def allWithProgress(_in, _out, dp, ignore, title):
    ...
    for item in zin.infolist():
        ...
        elif item.filename == 'userdata/Database/MyVideos119.db' and KEEPMYVIDEOS == 'true': skip = True
        elif item.filename == 'userdata/addon_data/pvr.iptvsimple' and KEEPPVR == 'true': skip = True
